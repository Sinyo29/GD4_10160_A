        ...
        <div class="container min-vh-100 mt-5 d-flex align-items-center justify-content-center"> 
          <div class="card text-dark bg-light ma-5 shadow " style="min-width: 25rem;"> 
            ...
            <div class="card-body"> 
              ...
              <p class="mt-2 mb-0">Sudah punya akun ? <a href="./loginPage.php" class="text-pri-
mary">Login Disini!</a></p> 
            </div> 
          </div> 
        </div> 
    </div> 
...
rity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anony-
mous"></script> 
  </body> 
</html>             